...
if lbvi_flag and bvi_flag and ubvi_flag:
    ...
    # ksd error bars
    #ax3.errorbar(range(1,niter+1), lbvi_ksd_median, yerr = lbvi_kernels_err, linestyle = 'solid', color = lbvi_color, label='LBVI')
    #ax3.errorbar(range(1,niter+1), ubvi_ksd_median, yerr = ubvi_kernels_err, linestyle = 'solid', color = ubvi_color, label='UBVI')
    #ax3.errorbar(range(1,niter+1), bvi_ksd_median, yerr = bvi_kernels_err, linestyle = 'solid', color = bvi_color, label='BVI')
