...
python3 -W ignore ../tests.py -d 2 --target 'double-banana-gaussian' -B 1000 --reps 1 --tol 0.0 --stop 'default' --kl --plot --lbvi_smc -N 25 --smc 'smc' --maxiter 20 --smc_eps 0.05 --smc_sd 1. --smc_T 25 --smc_w_maxiter 20 --smc_b_maxiter 10 --smc_cacheing --verbose --seed 123
