...
# run simuluation
python3 -W ignore ../tests.py -d 2 --target 'double-banana-gaussian' -B 1000 --reps 1 --tol 0.0 --stop 'median' --kl -N 20 --kernel 'gaussian' --rkhs 'rbf' --gamma 0.5 --maxiter 20 -t 100 -T 2100 --weight_max 20 --cleanup --verbose --ubvi_kernels 20 --ubvi_init 1000 --ubvi_inflation 1 --ubvi_logfg 1000 --ubvi_adamiter 1000 --bvi --bvi_kernels 20 --bvi_diagonal --bvi_init 100 --bvi_alpha 100
