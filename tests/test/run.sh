...
python3 -W ignore ../tests.py -d 1 --target 'cauchy' -B 1000 --reps 1 2 3 4 5 --tol 0.0 --stop 'default' --kl --lbvi -N 5 --kernel 'gaussian' --rkhs 'rbf' --gamma 10 --lbvi_recycle --maxiter 20 -t 100 -T 2100 --weight_max 20 --no_cache --cleanup --verbose
