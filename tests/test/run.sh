...
python3 -W ignore ../tests.py -d 2 --target 'four-banana' -B 1000 --reps 1 --tol 0.0 --stop 'median' --gvi --hmc --hmc_T 5000 --hmc_L 100 --hmc_eps 0.1 --rwmh --rwmh_T 5000 --cleanup --verbose
