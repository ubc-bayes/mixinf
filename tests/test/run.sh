...
python3 -W ignore ../tests.py -d 2 --target 'four-banana' -B 1000 --reps 1 --tol 0.0 --stop 'median' --lbvi -N 50 --kernel 'gaussian' --rkhs 'rbf' --maxiter 20 -t 25 -T 500 --weight_max 20 --cleanup --verbose
